...
export const sendTwoFactorTokenEmail = async (
    ...
    const options = {
        from: '"onboarding" <conference1ciences@gmail.com>', // Tu dirección de correo electrónico de Gmail
        to: email,
...
export const sendPasswordResetEmail = async (
    ...
    const resetLink = `https://gastronomy-system-model-git-main-bradcito-corros-projects.vercel.app/auth/new-password?token=${token}`;
...
export const sendVerificationEmail = async (
    ...
    const confirmLink = `https://gastronomy-system-model-git-main-bradcito-corros-projects.vercel.app/auth/new-verification?token=${token}`;
